  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <Box
            sx={{
              ...
              width: "100%",
              height: "100%",
              bgcolor: "rgba(0, 0, 0, 0.55)", // Dark overlay
              display: "flex",
              flexDirection: "column",
              justifyContent: "center",
              alignItems: "center",
        ...
        >
          <Typography variant="h6" fontWeight="bold">Key Coursework</Typography>
          <ul style={{ listStyleType: "none", padding: 0 }}>
            {edu.coursework.map((course, i) => (
              <li key={i} style={{ fontSize: "14px", margin: "5px 0" }}>• {course}</li>
            ))}
          </ul>
          <Button
            variant="contained"
